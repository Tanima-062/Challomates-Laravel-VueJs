<template>
    <span class="filter-menu__label--title" @click="toggleOpen" v-html="filterDateLabel()">

    </span>
    <div class="datepicker" v-if="open" v-click-away="close">
        <v-date-picker
            ...
            <template v-slot="{ inputValue, inputEvents }">
                <div class="filter-date-range-picker shadow-md rounded-b-md">
                    <input id="date" class="challo__input" :value="inputValue.start" v-on="inputEvents.start"  :placeholder="$t('TT.MM.JJJJ')" />
                    <span class="">
                    ...
                    <input id="date" class="challo__input" :value="inputValue.end" v-on="inputEvents.end"  :placeholder="$t('TT.MM.JJJJ')" />
