<template>
    ...
    >
        ...
        <ul
            class="filter-option__items max-h-[500px] overflow-y-auto absolute bg-white min-w-[150px] shadow-sm rounded-b-md z-[1]"
            v-show="active"
        >
            <li
...
const options = computed(() => {
    const customOptions = [
        { [props.valueKey]: "active", [props.labelKey]: "Nur Aktive" },
        { [props.valueKey]: "inactive", [props.labelKey]: "Nur Inaktive" }
    ]
    return [...customOptions, ...props.options]
})
