<template>
    <div :class="[$attrs.class]" style="width: 100%">
        <label v-if="label" class="form-label block mb-[8px]">{{ label }}</label>
        <div class="phone_input"
             :style="styles"
             :class="{ 'input-field-error' : ( show_error || ( !is_valid && phone_number.length > 0 ) ), 'valid-number' : ( is_valid && !show_error), }"
        >
