<template>
    <div class="challo__card challo__card-p6 rounded-b-3xl">
        <h5 class="page-title">{{ $t("Neuer Booster hinzufügen") }}</h5>
        <div class="form-wrapper">
            <form class="classic-form" @submit.prevent="create">
                <div class="form-field">
                    <div class="input-wrapper">
                        <label for="">{{ $t("Booster-ID") }}*</label>
                ...
                <div class="form-field">
                    ...
                    <div class="input-wrapper w-1/3">
                        ...
                        <SearchSelect v-model="form.contract" :options="contracts" valueKey="id"
                            ...
                            :error="form_error.contract.error"
                ...
                <div class="form-field">
                    <div class="input-wrapper">
                        <div class="challo__textarea">
                            ...
                            <input type="text" name="title" style="border:none; outline:none; margin-left:10px; width:80%" v-model="form.title" maxlength="41" @keyup="form_error.title.error=false">
                            ...
                            <input type="file" name="file" ref="file" id="fileInput" style="display:none" @change="uploadFile($event)">
                            <div class="flex">
                                <div class="flex w-2/3">
                                    <img src='/images/image.png' width=20 height=20 style="margin-right: 10px; margin-bottom: 3px;" @click="$refs.file.click()" id="img"/><span id="filename-show">{{$t('Bild hochladen')}}</span>
                                </div>

                                <span @click="removeFile()" style="display:none" id="remove" class="flex w-1/3">
                ...
                <div class="form-field">
                    ...
                    <div class="input-wrapper w-1/3">
                        ...
                        <select class='challo__input mt-1' name="booster_type" v-model="form.booster_type" :style="form_error.booster_type.error==true ? 'border-color:red' : ''" @change="form_error.booster_type.error=false">
                    ...
                    <div v-if="form.booster_type=='Recurring'" class="input-wrapper w-1/3">
                        <TextInput
                            ...
                            :show_error="form_error.number_of_boosters_month.error"
                            @keyup="formGenerate($event);form_error.number_of_boosters_month.error=false"
                ...
                <div class="form-field row">
                    ...
                    <div class="input-wrapper w-1/3">
                        <Cancel
                            ...
                            message="Registrierung des Boosters abbrechen?"
                            text="Wenn Sie diesen Vorgang abbrechen, werden alle Daten verworfen. Sind Sie sicher, dass Sie die Registrierung dieses Boosters wirklich abbrechen wollen?"
                        />
                    </div>
                </div>
            </form>
...
<script setup>
    ...
    const props = defineProps(["sales_partners", "latest_id"]);
    ...
    const inviteable = computed(() => {
        ...
        if(form.sales_partner == "" || form.contract == "" || form.title == "" || form.body == "" || form.range == "" || form.booster_type == "") {
            return false
        } else {
    ...
    const rules = {
        ...
        number_of_boosters_month: {required},
        start: {required},
        end: {required}
    };
    ...
    const removeFile = () =>{
        ...
        document.getElementById("img").setAttribute("src", "/images/image.png");
    ...
    const create = async () => {
        ...
        else if(inviteable.value == true && isValidForBoosterType == true && form.title.length < 41 || (form.body != "" && form.body.length < 251)){
            form.post(route("boosters.store"), {
                forcedData: true,
