                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="header center" width="100%" style="margin: 0;padding:0;">
                                                        ...
                                                        CHalloMates E-Mail Adressverifikation
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                Um die CHalloMates Mobile App mit Deiner neu eingegebenen E-Mail-Adresse nutzen zu können, bitten wir Dich, diese durch Eingabe des folgenden Verifizierungscodes zu verifizieren:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
