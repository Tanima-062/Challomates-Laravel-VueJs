...
<head>
    ...
    <title>CHalloMates Mobile App Benutzerprofil löschen</title>
                                                ...
                                                <tr>
                                                    <td class="header center" width="100%" style="margin: 0;padding:0;">
                                                        ...
                                                        <h1 class="header-title" style="margin:0;padding:0;font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 600;font-size: 33px;line-height: 36px;color: #1AA1E4;">
                                                            CHalloMates Mobile App Benutzerprofil löschen
                                                        </h1>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                        ...
                                                        <td class="body-padding mobile-padding"
                                                            ...
                                                            <table class="body" style="height: 100px;background:transparent;border:none;width:100%;">
                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                Um Ihr CHalloMates Mobile App Benutzerprofil zu löschen, verifizieren Sie es bitte durch Eingabe des Bestätigungscodes:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                        <td  style="">
                                                                                            <p style="margin: 25px 0px 25px 0px; font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 600;font-size: 20px;line-height: 28px;text-align: center;color: #135F84;">
                                                                                                {{ $otp }}
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                    ...
                                                                    {{-- <tr>
                                                                        <td style="width: 100%;">
                                                                            <p style="margin:0;padding:0;font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 400;font-size: 12px;line-height: 18px;text-align: center;color: #787878;">
                                                                                Sollten Sie dies nicht angefordert haben, können Sie diese E-Mail ignorieren. Ihr Passwort ändert sich erst, wenn Sie auf den obigen Link zugreifen und ein neues erstellen.
                                                                            </p>
                                                                        </td>
                                                                    </tr> --}}
                                                                </tbody>
