                                            ...
                                            <table class="w320" style="width: 400px; "
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="">
                                                        <td style="">
                                                            <center>
                                                                {{-- <img src="asset('images/logo_email.png')" alt="" style="margin-top: 32px;" height="24" /> --}}
                                                                <img src="{{ asset('images/logo_email.png') }}" alt="" style="margin-top: 32px;" height="29" />
                                                            </center>
                                                        </td>
                                                    </tr>
                                                </tbody>
