                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                Sie wurden für CHalloMates als Administrator eingeladen. Bitte bestätigen Sie zunächst Ihre E-Mail Adresse, indem Sie auf den folgenden Link klicken:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                        <td  style="">
                                                                                            <div align="center">
                                                                                                <a style="width:310px;background-color: #06CEB5; border-radius: 32px; color: #ffffff; display: inline-block; font-family: 'Poppins', sans-serif; font-size: 16px; line-height:19.2px; font-weight: 700;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; mso-hide: all; margin-top: 35px; border: 12px solid #06CEB5"
                                                                                                href="{{ $url }}" target="_blank" rel="noopener noreferrer">E-Mail Adresse verifizieren</a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
