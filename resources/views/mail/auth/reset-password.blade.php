                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                Sie haben Ihr Passwort vergessen und möchten dies<br> zurücksetzen? Ihr neues Passwort können Sie einrichten, <br>indem Sie auf den folgenden Link klicken:
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                        <td  style="">
                                                                                            <div align="center">
                                                                                                <a style="width:310px;background-color: #06CEB5; border-radius: 32px; color: #ffffff; display: inline-block; font-family: 'Lato', sans-serif; font-size: 16px; line-height:19px; font-weight: 700;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; margin-top: 32px; border: 12px solid #06CEB5"
                                                                                                href="{{ $url }}"
...
<!--                                                                                    <tr>
                                                                                        <td>
                                                                                            <div align="center" style="margin-top: 20px;">
                                                                                                <p
                                                                                                    style=" color: #787878; display:  font-family: 'Poppins', sans-serif; font-size: 14px;line-height:16px; font-weight: 400;text-align: center; text-decoration: none;  -webkit-text-size-adjust: none; margin-bottom:40px;  word-break: break-all;"
                                                                                                >{{ url($url) }}</p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>-->
                                                                                        ...
                                                                                        <td>
                                                                                            <div align="center" >
                                                                                                <p
                                                                                                    ...
                                                                                                    >
                                                                                                    Sollten Sie dies nicht angefordert haben, können Sie diese E-Mail <br>ignorieren. Ihr Passwort ändert sich erst, wenn Sie auf den obigen Link <br>zugreifen und ein neues erstellen.
                                                                                                </p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
