                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            ...
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                                                ...
                                                                                                Du hast Dein Passwort vergessen und möchtest dies zurücksetzen?
                                                                                                Dein neues Passwort kannst Du schnell
                                                                                                und einfach einrichten, indem Du auf den folgenden
                                                                                                Link klickst:
                                                                                        ...
                                                                                        <td>
                                                                                            <div align="center" style="margin-top: 20px;">
                                                                                                <a
                                                                                                    ...
                                                                                                    href="{{ url($url) }}"
                                                                                                    >Solltest Du dies nicht angefordert haben, kannst Du diese E-Mail ignorieren.
                                                                                                    Dein Passwort ändert sich erst, wenn Du auf den obigen Link zugreifst und ein neues erstellst.</a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
