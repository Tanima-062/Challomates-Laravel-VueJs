...
<head>
    ...
    <title>Ihr CHalloMates QR Code</title>
                                            ...
                                            <table class="w320" style="width: 400px; "
                                                ...
                                                <tbody>
                                                    <tr style="">
                                                        <td class="body-padding mobile-padding"
                                                            ...
                                                            {{-- <table class="soapbox"
                                                                ...
                                                                <tbody>
                                                                    <tr style="height: 10px;">
                                                                        <td class="body-text-cell" align="center">
                                                                           <p   style="font-family: 'Poppins', sans-serif;font-style: normal;font-weight: 600;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0;">
                                                                            <center>
                                                                                Guten Tag {{ $sales_partner->contact_person_first_name.' '.$sales_partner->contact_person_last_name }}
                                                                            </center>
                                                                           </p>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <table class="body-text"
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="">
                                                                                        <td class="body-text-cell"
                                                                                            style="">
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0; margin-bottom: 10px;">
                                                                                                Anbei senden wir Ihnen gerne den QR Code für Ihren Store für die CHalloMates Mobile App.
                                                                                            </p>
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0; margin-bottom: 10px;">
                                                                                                Bitte drucken Sie diesen aus und platzieren diesen übersichtlich in Ihrem Geschäft.
                                                                                            </p>
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0; margin-bottom: 10px;">
                                                                                                Ihre Gäste, welche noch keine CHalloMates Mobile App-Benutzer sind, können die Mobile App im App Store herunterladen und sich in der Mobile App mit der Option “QR-Code Scannen” und dem anschliessenden Scannen Ihres Store-QR Code über Ihren Store für die App registrieren.
                                                                                            </p>
                                                                                            <p style="font-family: 'Poppins', sans-serif ;font-style: normal;font-weight: 400;font-size: 15px;line-height: 22px;text-align: center;color: #135F84;margin:0;padding:0; margin-bottom: 10px;">
                                                                                                Sind bei Ihnen bereits für die CHalloMates registrierte Gäste zu Besuch, können diese mittels dem Scannen Ihres Store-QR Codes in Ihrem Store einchecken.
                                                                                            </p>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr style="">
                                                                                        <td  style="">
                                                                                            <center>
                                                                                                <img src="{{ $message->embed($file_name) }}" style="margin-top: 32px;">
                                                                                                {{-- <img src="{{ $message->embedData($data, 'qr-code.png') }}" style="margin-top: 32px;"> --}}
                                                                                                {{-- <img src="data:image/png;base64,{{ $data }}" style="margin-top: 32px;"> --}}
                                                                                            </center>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                    ...
                                                    <tr style="">
                                                        <td style="">
                                                            <center>
                                                                <img src="{{ asset('images/logo_email.png') }}" alt="" style="margin-top: 32px;" height="40" />
                                                            </center>
                                                        </td>
                                                    </tr>
                                                </tbody>
