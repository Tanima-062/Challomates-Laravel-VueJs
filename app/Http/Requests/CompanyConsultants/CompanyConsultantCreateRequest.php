...
class CompanyConsultantCreateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            //'phone_number'           => ["required", "phone:country_iso_code", new UniquePhoneNumber(User::class, $this->country_iso_code)],
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if (User::where('email', $this->email_address)->exists()) {
