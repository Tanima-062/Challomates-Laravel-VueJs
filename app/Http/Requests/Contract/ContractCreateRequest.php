...
class ContractCreateRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $contract_already_exists = Contract::where('sales_partner_id', $this->sales_partner_id)->where(fn ($q) => $q->whereDate('contract_term_from', '<=', $end_date)->whereDate('contract_term_to', '>=',$start_date))->exists();
